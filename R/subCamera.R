...
#' @param returnMatrix a logical, whether to return -log10 p-value * sign matrix
...
#' @references Wu D, Smyth GK. Camera: a competitive gene set test accounting for inter-gene correlation. Nucleic Acids Res. 2012;40:e133. Available from: \url{https://www.ncbi.nlm.nih.gov/pmc/articles/pmid/22638577/}
#' @examples
...
subCamera <- function(emat, class, keepN = TRUE, batch = NULL,
                      ...
                      legendAdd = TRUE, returnMatrix=FALSE, ...)
{
    ...
    if (returnMatrix) return(cam.mat)
    invisible(cont.cam)
}
